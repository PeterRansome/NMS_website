	...
	<section class="bg-gray text-center">
      <div class="container wow fadeIn">
		...
		<div class="col-md-2 col-sm-6">
          ...
          <div class="col-md-2 col-sm-6">
            <p><img class="img-responsive center-block" src="/assets/img/deafult.jpg" alt=""></p>
          ...
          <div class="col-md-2 col-sm-6">
            ...
            <ul class="list-inline">
              <li><a href="https://twitter.com/wookieh4k"><i class="fab fa-twitter fa-lg"></i></a></li>
            </ul>
            <h6>Content Creator</h6>
          </div>
          <div class="col-md-2 col-sm-6">
          ...
          <div class="col-md-2 col-sm-6">
            <p><img class="img-responsive center-block" src="/assets/img/default.png" alt=""></p>
            <h2 class="classic">NMS Elizabeth</h2>
            <ul class="list-inline">
              <li><a href="https://twitter.com/NMSorg"><i class="fab fa-twitter fa-lg"></i></a></li>
            </ul>
            <h6>Content Creator</h6>
          </div>
          <div class="col-md-2 col-sm-6">
